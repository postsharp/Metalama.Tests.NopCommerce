...
object ReleaseBuild : BuildType({
    ...
    dependencies {
        dependency(AbsoluteId("Metalama_Metalama20234_Metalama_ReleaseBuild")) {
            snapshot {
                     onDependencyFailure = FailureAction.FAIL_TO_START
            }
        ...
        dependency(AbsoluteId("Metalama_Metalama20234_MetalamaFrameworkRunTime_ReleaseBuild")) {
            snapshot {
                     onDependencyFailure = FailureAction.FAIL_TO_START
            }
...
object PublicDeployment : BuildType({
    ...
    dependencies {
        ...
        dependency(AbsoluteId("Metalama_Metalama20234_Metalama_PublicDeployment")) {
            snapshot {
                     onDependencyFailure = FailureAction.FAIL_TO_START
            }
        }
