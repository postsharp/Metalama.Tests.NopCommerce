...
namespace Metalama.Aspects
{
    ...
    public class MethodFabric : TransitiveProjectFabric
    {
        public override void AmendProject(IProjectAmender amender)
        {
            ...
            amender.Outbound.SelectMany(p => p.Types.SelectMany(t => t.Methods).Where(m => m.IsAsync && !m.IsGeneric)).AddAspect<LoggingAspect>();
            ...
            amender.Outbound.SelectMany(p => p.Types.SelectMany(t => t.Methods).Where(m => !m.IsAbstract && !m.IsImplicitlyDeclared)).AddAspect<LoggingAspect>();
    ...
    public class IntroductionFabric : TransitiveProjectFabric
    {
        public override void AmendProject(IProjectAmender amender)
        {
            amender.Outbound.SelectMany(p => p.Types.Where(t => t.TypeKind is not (TypeKind.Interface or TypeKind.Enum or TypeKind.Delegate) && !t.IsImplicitlyDeclared)).AddAspect<FieldIntroductionAttribute>();
            amender.Outbound.SelectMany(p => p.Types.Where(t => t.TypeKind is not (TypeKind.Interface or TypeKind.Enum or TypeKind.Delegate) && !t.IsImplicitlyDeclared)).AddAspect<MethodIntroductionAttribute>();
        }
    }
