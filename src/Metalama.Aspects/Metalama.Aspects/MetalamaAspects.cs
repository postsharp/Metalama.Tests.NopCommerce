...
namespace Metalama.Aspects
{
    ...
    public class MethodFabric : TransitiveProjectFabric
    {
        public override void AmendProject(IProjectAmender amender)
        {
            ...
            amender.SelectMany(p => p.Types.SelectMany(t => t.Methods).Where(m => !m.IsAsync && !m.IsAbstract && !m.IsImplicitlyDeclared))
                .AddAspects(new ForcedJumpOverrideAspect(), new UninlineableOverrideAspect());

            amender.SelectMany(p => p.Types.SelectMany(t => t.Methods).Where(m => m.IsAsync && !m.IsGeneric))
                .AddAspects(new ForcedJumpOverrideAspect(), new UninlineableOverrideAspect());
